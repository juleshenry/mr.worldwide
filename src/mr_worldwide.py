...
def get_lang_sort_key(lang_code):
    ...
    # Priority within its own region (or just at the very beginning)
    try:
    ...
    # Return key that prioritizes by priority list first, then region, then alphabetically
...
def get_background_image(lang_code, size, word="hello", used_images=None):
    ...
    if word_clean == "hello":
        assets_dir = get_path("hello_assets")
    elif word_clean == "love":
        assets_dir = get_path("love_assets")
    else:
...
def get_font_for_lang(lang_code, text, preferred_path):
    ...
    script_ranges = [
        ...
        ("\u3400", "\u4dbf", get_path("fonts/NotoSansSC-Regular.otf")),
        ("\u3040", "\u309f", get_path("fonts/NotoSansJP-Regular.otf")),
        ("\u30a0", "\u30ff", get_path("fonts/NotoSansJP-Regular.otf")),
        ("\uac00", "\ud7af", get_path("fonts/NotoSansKR-Regular.otf")),
        ("\u3000", "\u303f", get_path("fonts/NotoSansSC-Regular.otf")),
        ("\uff00", "\uffef", get_path("fonts/NotoSansSC-Regular.otf")),
    ]
    ...
    fallbacks = [
        get_path("fonts/NotoSans-Regular.ttf"),
        get_path("fonts/arial.ttf"),
        get_path("fonts/Quivira-A8VL.ttf"),
    ]
...
def create_gif(params):
    ...
    def create_frame(
        ...
        if params.use_flag_colors or params.rainbow:
            ...
            elif use_icons or params.smart_color:
...
def main():
    ...
    parser.add_argument(
        "--font_path",
        default=get_path("fonts/NotoSans-Regular.ttf"),
